...
SECRET_KEY = 'fo(=_$2#*f0%v%xeclr5&amp;po-o(ierzku^9my%m9ofqujdgm3k2'
...
SQLALCHEMY_DATABASE_URI = 'postgres://anthill_backup@/anthill_backup'

LOCATION = 'http://localhost:9625'
BROKER = 'amqp://guest:guest@localhost:5672'

# ROUTES_CONF = 'backup.routes'
...
CACHES["default"]["LOCATION"] = "redis://localhost:6379/35"
CACHES["default"]["KEY_PREFIX"] = "backup.anthill"
...
LOGGING = {
    ...
    'handlers': {
        ...
        'anthill.server': {
            ...
            'filename': '/var/log/anthill/backup.log',
            'formatter': 'anthill.server',
...
GRAPHENE = {
    'SCHEMA': 'backup.api.v1.public.schema',
    'MIDDLEWARE': ()
}
